...
export default function Register({navigation}:Props) {
  ...
  const [emailDifferent, setEmailDifferent] = useState("Seu email não está no formato")
  ...
  return (
    <View style={styles.allRegister}>
      ...
      <View style={styles.inputViewRegister}>
        ...
        {buttonActive? (name!== "" && userName!=="" && email !== "" && password !== "" && confirmPassword!== "" && password.length >= 8 && password === confirmPassword && email.indexOf("@") !== -1?(
